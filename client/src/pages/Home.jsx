...
const Home = () => {
  ...
  return (
    <>
      <div className="relative w-full h-screen bg-gradient-to-r from-gray-800 via-purple-900 to-black overflow-hidden">
        {/* Grid Background */}
        <div
          ...
          style={{
            ...
            WebkitMaskImage: `linear-gradient(to bottom, rgba(0, 0, 0, 1) 10%, rgba(0, 0, 0, 0) 80%),linear-gradient(to right, rgba(0, 0, 0, 1) 20%, rgba(0, 0, 0, 0) 80%)
    `,
            maskImage: `
    ...
    `,
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-bold">
            ...
            <span className="text-blue-400">AdVise</span>
          </h1>
          <p className="mt-8 mb-4 text-lg opacity-80 max-w-3xl">
            AdVise provides AI-driven insights to help marketers create
            compelling ads. By analyzing user pain points, competitor
            strategies, and trending hooks and CTAs, it helps you design ads
